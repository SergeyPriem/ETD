...
def scripts_tab():
    ...
    with col_2:
        ...
        st.text('', help='В настоящее время доступны следующие скрипты:\n'
                         ...
                         '- :orange[Генерация разрезов кабельных трасс]\n'
                         '- :orange[Распределение однофазных нагрузок по фазам]\n'
                         '***'
                         ...
                         '- :orange[Cableway Sections Generation]'
                         '- :orange[Single phase loads distribution]'
                )
    ...
    with col_content:
        ...
        with st.expander("CREARE CABLE LIST  |  SLD FROM LOAD LIST  |  XML FOR ETAP"):
            ...
            tab_cl, tab_sld, tab_xml = st.tabs(['1️⃣ Create Cable List  ⏩️️', '2️⃣ Create SLD in DXF  ⏩️',
                                                '3️⃣ Greate XML for ETAP'])
