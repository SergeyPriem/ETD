...
def drawing_sets():
    ...
    with content:
        ...
        with st.form("edit-unit_details"):
            ...
            r_c.text_area("Notes (existing)", value=old_notes, max_chars=1500, height=123, disabled=True)
            ...
            l_c.text_area(label="Transmittals' History", value=old_trans, height=123, disabled=True)
