...
#
#
# def to_dxf(df, msp, vert_trays_gap):
#     p_y = 0
#     shift = 0
...
#
#     msp.add_text("of trays: " + str(int(vert_trays_gap) * 10) + " mm", height=3, dxfattribs={"style": "ГОСТ"}
...
#                             (p_y_cab - (vert_trays_gap * (v.chan_level - 1)) + cab_radius + 0.2))
...
#
#
# def gener_section(cablist_df, df_b, section, sect_df, sections_template_path, msp, vert_trays_gap, reply):
...
#         to_dxf(sect_final_df, msp, vert_trays_gap)
...
#
# # main4
# def generate_dxf(sect_df, sections_template_path, cablist_df, vert_tray_gap):
#
...
#                 gener_section(cablist_df, df_sect, section, sect_df, sections_template_path, msp, vert_tray_gap, reply)
#
