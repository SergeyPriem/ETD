...
def col_py():
    ...
    with col_content:
        ...
        if load_list:
            ...
            st.download_button('Get Load List here', file_name=load_list, mime=None, key=None, help=None,
                               on_click=None, args=None, kwargs=None, disabled=False, use_container_width=False)

        if dxf_template:

            st.download_button('Get SLD here', file_name=dxf_template, mime=None, key=None, help=None,
                               on_click=None, args=None, kwargs=None, disabled=False, use_container_width=False)
